...
export class Embed extends React.Component<Props, State> {
  ...
  render() {
    return this.state.photo && this.state.photo.urls
      ? <div style={{maxWidth: "666px", margin: "15px 0", border: "1px solid #f1f1f1", borderRadius: "4px", boxShadow: "0 2px 4px #f1f1f1", overflow: "hidden"}}>
        <img style={{display: "block", width: "100%"}} src={this.state.photo.urls.regular} />
        <div style={{fontSize: "15px", fontFamily: "-apple-system,San Francisco,Helvetica Neue,Helvetica,sans-serif", color: "#111", padding: "20px"}}>
          <div style={{display: "flex"}}>
            <span style={{flex: 1}}>
              <a href={this.state.photo.user.links.self} target="_blank" style={{display: "inline-flex", alignItems: "center", color: "#999", textDecoration: "none", marginRight: "10px"}}>
            ...
            {this.props.show_like_button && <a style={{display: "flex", alignItems: "center", color: "#999", fill: "currentColor", textDecoration: "none", height: "32px", borderRadius: "4px", border: "1px solid #ddd", padding: "0 11px", marginRight: "10px"}} href={this.state.photo.links.download}>
